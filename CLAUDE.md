...
- `rectGrid: true` → the "4 notes per rectangle" layout for phone solo/bass/chords. Legal iff **`(iv.length + (periodOf===2?1:0)) % 4 === 0`** (19→20, 31→32, Partch 44, gamma 20). Drives `rectRows`/`rectRowsFull`.
