...
const LOOPER_STEPS=[
  ...
  /* СЛОЙ ПО РОЛЯМ — теперь это ПЕДАГОГИКА, а не обход ограничения. Прежняя причина («соло — один
     ...
     через смену роли: услышать ДВА РАЗНЫХ голоса (соло+аккорды) нагляднее, чем два соло. done: сменил
     роль на ch/bs, завершил овердаб (● стоп) И реально сыграл в этой роли (chordPlayed/bassPlayed
