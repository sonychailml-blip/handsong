...
export const SCALES=[
 ...
 /* Пифагоров строй — 12 нот из цепочки ЧИСТЫХ квинт 3/2 (показатели −5..+6), свёрнутых в октаву.
    ...
    сам механизм; noChords пока (аккорды — следующим проходом). Натуральный (чистые терции, но фальшивые
    квинты) станет контрапарой. trad:'modal', новая grp «Исторические темперации» — про РАЗНЫЕ СТРОИ
    ОДНИХ И ТЕХ ЖЕ 12 НОТ (пифагоров/натуральный/мезотоника), а НЕ утверждение, будто макам/гамелан
    «менее историчны» — те живут в своих традициях. Сюда же лягут Натуральный/мезотоника. tag:'penta' —
    инертный (как у Слендро/Пелог: не 'dia'/'ethnic'/'maqam'/'edo'), читателя не заводим. Индекс 57, В КОНЕЦ. */
 {name:'Пифагоров строй (чистые квинты)', trad:'modal', grp:'Исторические темперации', edo:12, iv:range(12),
    cents:[0,90.22,203.91,294.13,407.82,498.04,611.73,701.96,792.18,905.87,996.09,1109.78], tag:'penta', noChords:true},
];
