...
export const SCALES=[
 ...
 /* Партч (Harry Partch, «Genesis of a Music») — 43-тоновая ЧИСТАЯ ИНТОНАЦИЯ (11-предельный
    ...
    регистр 2^oct не трогаем — строй ОКТАВО-повторяющийся. noChords: chordSteps/chordFreqs не
    знают про cents. rectGrid: 43+1=44, 44/4=11 прямоугольников (кратность 4 держится).
    tag:'ji' — не 'edo'/'penta': аккордов не строит, как равный EDO не читается.
 ...
 {name:'Партч (43 тона, чистая интонация)', trad:'world', grp:'', edo:43, iv:range(43),
    ...
    tag:'ji', noChords:true, rectGrid:true},
];
