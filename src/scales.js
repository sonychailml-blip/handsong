...
/* Типизированные аккорды (UI-MAP «Хроматика»): аккорд задаётся не ступенью лада, а
   СЕМЕЙСТВОМ (палец левой руки) + ВАРИАНТОМ (сектор по X).
...
/* НАБОРЫ СЕМЕЙСТВ ПО ЛАДАМ. Интервалы — В ШАГАХ СВОЕГО СТРОЯ от корня; для 12-TET шаг
   ...
   Число секторов = длине types; рисование, попадание и гистерезис берут её из данных,
   поэтому 6 здесь ничем не отличается от 3 — таблицу можно менять свободно.
...
export const CHORD_FAM_SETS={
 ...
 chrom12:[
  ...
  {id:'dim', name:'Ум./Ув.', finger:2, types:[          // палец: безымянный
    {label:'dim',   iv:[0,3,6]},
  ...
  /* Мизинец: sus + расширенные. Имя семейства не «Sus» — в наборе лежат 6/9, maj9 и 13,
     которые sus не являются; индикатор не должен врать. */
  {id:'sus', name:'Sus и расшир.', finger:3, types:[    // палец: мизинец
    {label:'sus2',  iv:[0,2,7]},
    {label:'sus4',  iv:[0,5,7]},
 ...
 edo31:[
  ...
  {id:'neu', name:'Нейтр./Ум.', finger:2, types:[       // палец: безымянный
