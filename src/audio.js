...
/* ═══ ДЕЛЕЙ — ШИННЫЙ ЭФФЕКТ ЦЕПИ (слайс в.1) ═══
   ...
   проводку «в каждый источник», которую запрещает требование универсальности. Разрешается в ПЛАСТЕ 3.8:
   пер-слойным сетям так или иначе нужны пер-слойные экземпляры, а такие экземпляры естественно несут
   СВОИ значения.
   ...
   как длина/окраска реверба.
     ...
     ⚠️ СЕТЕВЫЕ СЕЙЧАС ОБЩИЕ ДЛЯ ВСЕХ СЛОЁВ РОЛИ; пер-слойные время и повторы — это и есть Пласт 3.8. */
...
/* ═══ ТРЕМОЛО (МИКС) — ШИННАЯ ВСТАВКА ЦЕПИ (слайс в.2) ═══
   ...
   всю карту). Это СЕТЕВОЙ параметр, как длина реверба: состояние роли, пер-слойность — Пласт 3.8.
