...
/* ДЛИНА ХВОСТА (RT60 → обратная связь каждой линии). g_i = 10^(−3·d_i/RT60): сигнал, обошедший линию
   ...
   одинаковый хвост на четырёх РАЗНЫХ задержках. Разгон невозможен трижды: g<1 математически при любом
   конечном RT60, сверху кламп gMax, плюс потери на ФНЧ в петле; последний рубеж — мастер-лимитер. */
