...
export {
  ...
  FX_FACTORY, fxInstance, fxSetActive, fxChainResplice, fxSnapshot, fxChordBri,   // ЧТО существует (статика, есть до initAudio — по ней меню строит список), ЧТО построено (живой экземпляр роли: gestures пишет параметры, draw читает величины для столбиков) и ВКЛ/ВЫКЛ прицепки (ui — при снятии/возврате эффекта в цепь)
};
