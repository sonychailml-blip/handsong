...
export const DICTS = {
  en: {
    ...
    'tutor.step1.prompt':'Pinch your right thumb and index finger together — a note plays.',
    'tutor.step1.detail':'Notes come from your right hand — the left hand is for effects. Touch your right thumb and index fingertip together until you hear a note.',
    'tutor.step2.prompt':'Now move your hand up and down. The pitch follows.',
    'tutor.step2.detail':'Keep pinching and slide your hand higher, then lower. Higher hand, higher note.',
    'tutor.step3.prompt':'Pinch a different finger — middle or ring — for a different octave.',
    'tutor.step3.detail':'Touch your thumb to another fingertip. Index, middle, ring and little finger each reach a higher octave.',
    'tutor.step4.prompt':'Your left hand controls effects. Pinch it and move up or down.',
    'tutor.step4.detail':'With your left hand, pinch a finger over the bars at the left edge, then slide up and down — you\'ll hear delay, vibrato and more.',
    ...
    'tutor.step6.prompt':'Pinch to play a chord. Move your hand to change it.',
    'tutor.step6.detail':'Touch your thumb and a finger together — a whole chord sounds. Move up and down for other chords.',
    'tutor.final.prompt':'That\'s the whole instrument. One thing you haven\'t touched: you\'ve been in one tuning, and there are 75. Open the scale menu — the button at the top — to hear Bhairav, gamelan, Bohlen–Pierce and more.',
  ...
  ru: {
    ...
    'tutor.step1.prompt':'Соедините большой и указательный пальцы ПРАВОЙ руки — щипок. Зазвучит нота.',
    'tutor.step1.detail':'Ноты играет правая рука — левая для эффектов. Сведите кончики большого и указательного пальцев правой руки, пока не услышите ноту.',
    'tutor.step2.prompt':'Теперь двигайте руку вверх и вниз — высота идёт следом.',
    'tutor.step2.detail':'Не размыкая щипок, ведите руку выше, потом ниже. Выше рука — выше нота.',
    'tutor.step3.prompt':'Щипните другим пальцем — средним или безымянным — для другой октавы.',
    'tutor.step3.detail':'Коснитесь большим пальцем другого кончика. Указательный, средний, безымянный и мизинец берут всё более высокую октаву.',
    'tutor.step4.prompt':'Левая рука управляет эффектами. Щипните ею и двигайте вверх или вниз.',
    'tutor.step4.detail':'Левой рукой щипните палец над столбиками у левого края и ведите вверх-вниз — услышите делей, вибрато и другое.',
    ...
    'tutor.step6.prompt':'Щипок — и звучит аккорд. Двигайте руку, чтобы менять его.',
    'tutor.step6.detail':'Сведите большой палец с другим — зазвучит целый аккорд. Двигайте вверх-вниз для других аккордов.',
    'tutor.final.prompt':'Это весь инструмент. Одного вы ещё не трогали: вы играли в одном строе, а их 75. Откройте меню строя — кнопкой вверху — чтобы услышать Бхайрав, гамелан, Болен–Пирс и другое.',
