...
export const DICTS = {
  en: {
    ...
    'tutor.lpJam.prompt':'Tap 🎵 Jam — a ready-made backing starts, and you can play over it.',
    'tutor.lpJam.detail':'One tap gives you a backing that fits the current scale — chords and a beat where they suit, a plain drone where a beat would be wrong. Tap again for another.',
  ...
  ru: {
    ...
    'tutor.lpJam.prompt':'Нажмите 🎵 Джем — заиграет готовая подложка, поверх которой можно играть.',
    'tutor.lpJam.detail':'Один тап даёт подложку под текущий лад — аккорды и бит там, где они уместны, простой дрон там, где бит был бы неуместен. Ещё тап — другой вариант.',
