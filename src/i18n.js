...
export const DICTS = {
  en: {
    ...
    'roll.hint':'drag a hit — move · empty space — scroll · two fingers — zoom · tap the ruler — move the playhead',
  ...
  ru: {
    ...
    'roll.hint':'тянуть удар — перенос · пустое место — прокрутка · два пальца — зум · тап по линейке — бегунок',
