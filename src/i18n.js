...
export const DICTS = {
  en: {
    ...
    'roll.hint':'drag a hit — move · empty space — scroll · two fingers — zoom',
    // правка ударов (S5.1)
    ...
    'roll.snapTitle':'Snap · drag {d} · insert {i}',
    'roll.snapBar':'bar',
  ...
  ru: {
    ...
    'roll.hint':'тянуть удар — перенос · пустое место — прокрутка · два пальца — зум',
    ...
    'roll.snapTitle':'Сетка · перенос {d} · вставка {i}',
    'roll.snapBar':'такт',
