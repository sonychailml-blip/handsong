...
export const DICTS = {
  en: {
    ...
    /* ⛳ ЗАМОРОЗКА (F5). ❄ — заморозить/переморозить, ☀ — разморозить; «устарела» значит, что после
       заморозки дорожку правили и звучит она сейчас СВОИМИ СОБЫТИЯМИ, а не буфером. */
    'frz.freeze':'Freeze',
    'frz.refreeze':'Re-freeze',
    'frz.unfreeze':'Unfreeze',
    'frz.frozen':'frozen',
    'frz.stale':'stale — edited since freezing; playing its events',
    'frz.working':'Freezing…',
    'frz.workingPct':'Freezing… {pct}%',
    ...
    'roll.delTitle':'Delete the selected note or automation point',
  ...
  ru: {
    ...
    'frz.freeze':'Заморозить',
    'frz.refreeze':'Переморозить',
    'frz.unfreeze':'Разморозить',
    'frz.frozen':'заморожена',
    'frz.stale':'устарела — правили после заморозки; играет свои события',
    'frz.working':'Заморозка…',
    'frz.workingPct':'Заморозка… {pct}%',
    ...
    'roll.delTitle':'Удалить выбранную ноту или точку автоматизации',
