...
function laneReset(){ laneId.clear(); laneMute.clear(); laneSolo.clear(); armLane=null; delPend=null; takeReset(); }   // O-2: захват сбрасывается вместе с дорожками (✕ и старт записи на пустой песне)
